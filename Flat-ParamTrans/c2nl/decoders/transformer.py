...
from c2nl.modules.multi_head_attn import MultiHeadedAttention,ConcatMultiHeadedAttention
...
class TransformerDecoderLayer(nn.Module):
    ...
    def __init__(self,
        ...
        self.context_attn = ConcatMultiHeadedAttention(
            heads, d_model, d_k, d_v, dropout=dropout,
    ...
    def forward(self,
        ...
        memory_bank = torch.cat((memory_bank, memory_bank2), -1)
